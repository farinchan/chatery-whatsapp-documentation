# Chatery WhatsApp API Documentation

Documentation site for Chatery WhatsApp API - A powerful WhatsApp API backend built with Express.js and Baileys library. Built with Astro, Svelte, and Tailwind CSS.
...
git clone https://github.com/farinchan/chatery_whatsapp_docs.git

# Navigate to the project
cd chatery_whatsapp_docs
...
- **Overview** - Introduction and getting started guide
- **API Reference** - Sessions, Messaging, Chat History, Group Management
- **Advanced** - WebSocket Events, Webhooks, Code Examples
