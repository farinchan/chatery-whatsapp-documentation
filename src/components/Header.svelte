<script lang="ts">
	...
	import { Sun, Moon, Menu, Github, Heart } from 'lucide-svelte';
	...
	<div class="flex h-full items-center justify-between px-4 lg:pl-7">
		<a href="/" class="flex items-center gap-2">
			...
			<div class="flex items-center gap-2">
				<span class="font-medium text-[#19191C] dark:text-white">Chatery</span>
		...
		<div class="flex items-center gap-2 sm:gap-4">
			...
			<a
				href="/sponsorship"
				class="hidden items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium text-pink-600 transition-colors hover:bg-pink-50 dark:text-pink-400 dark:hover:bg-pink-950 sm:flex"
			...
			<a
				href="https://github.com/farinchan/chatery_whatsapp"
				target="_blank"
